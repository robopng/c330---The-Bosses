...
public class PlayerController : MonoBehaviour
{
    ...
    public float moveSpeed = 1f; // change this as needed
    ...
    void Update()
    {
        ...
        movement = new Vector2(moveX, moveY); // Prevents diagonal movement from being too fast.

        // Prevents from gliding
        ...
        if (Input.GetMouseButtonDown(0) && !isAttacking) // 0 is the Left Mouse Button
        {
            ...
            //StartCoroutine(MeleeAttackRoutine()); --- MOVING THIS TO A DIFFERENT CLASS, KEEPING THIS CLASS FOCUS ON MOVEMENT ---
        }
